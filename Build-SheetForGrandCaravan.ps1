...
foreach ( $file in $xmlFiles )
{
	...
	if ( $xmlData.MONRONEY.VINYEAR -eq $vinYear )
	{
...
$allVehicleData | Export-Clixml "C:\Temp\GrandCaravan\AllVehicleData.clixml"

$allDealerData = Import-Clixml "C:\Temp\GrandCaravan\allDealerList.clixml"

Write-Output $a | Out-File -FilePath "C:\Temp\GrandCaravan\SheetHeaders.csv" -Encoding ascii
Write-Output $b | Out-File -FilePath "C:\Temp\GrandCaravan\SheetHeaders.csv" -Encoding ascii -Append
Write-Output $c | Out-File -FilePath "C:\Temp\GrandCaravan\SheetHeaders.csv" -Encoding ascii -Append
Write-Output $d | Out-File -FilePath "C:\Temp\GrandCaravan\SheetHeaders.csv" -Encoding ascii -Append
}
...
foreach ( $file in $xmlFiles )
{
	...
	if ( $xmlData.MONRONEY.VINYEAR -eq $vinYear )
	{
		...
		$item.DealerState = $allDealerData.State
...
#	}
#}
#$allDealerData | Export-Clixml "C:\Temp\GrandCaravan\AllDealerData.clixml"
